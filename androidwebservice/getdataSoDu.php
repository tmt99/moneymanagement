 <?php
  //       $dinh_dang_cu = "30-3-2019";  
	...
	$query1 = "SELECT sotienchi FROM khoanchi WHERE ngaychi >='$fisrt_day_of_moth' AND ngaychi < '$fisrt_day_of_moth' + INTERVAL 1 MONTH AND khoanchi.tendangnhap='".$tendangnhap."'";
	$data1 = mysqli_query($connect,$query1);

	$query = "SELECT sotienthu FROM khoanthu WHERE ngaythu >='$fisrt_day_of_moth' AND ngaythu < '$fisrt_day_of_moth' + INTERVAL 1 MONTH AND khoanthu.tendangnhap='".$tendangnhap."'";
