<?php
	...
	$query = "SELECT * FROM khoanchi WHERE khoanchi.ngaychi BETWEEN CAST('$ngaybt' AS DATE) AND CAST('$ngaykt' AS DATE) AND khoanchi.tendangnhap='".$tendangnhap."'ORDER BY ngaychi DESC ";
